    ...
    <div class="loginContainer">
        ...
        <form class="loginForm">
            <section class="input_container">
                <input type="text" placeholder="账号" v-model.lazy="username"  v-model="phoneNumber">
            </section>
      ...
      <p class="login_tips">
        ...
        <router-link to="/register" class="to_forget" v-if="!loginWay">还没有账号？立刻注册</router-link>
...
<script>
    ...
    import {mobileCode, checkExsis, sendLogin, getcaptchas, accountLogin,login} from '../../service/getData'
